...
.method private updateImportantForAccessibility(Landroid/view/View;Z)V
    ...
    invoke-static {v5, v6}, Ldu/ad;->c(Landroid/view/View;I)V
...
# virtual methods
.method protected onCreateMotionSpec(Landroid/content/Context;Z)Lcom/google/android/material/transformation/FabTransformationBehavior$a;
    .registers 5

    if-eqz p2, :cond_5

    .line 64
    sget p2, Ljs/a$a;->mtrl_fab_transformation_sheet_expand_spec:I

    goto :goto_7

    .line 66
    :cond_5
    sget p2, Ljs/a$a;->mtrl_fab_transformation_sheet_collapse_spec:I
    ...
    .line 70
    invoke-static {p1, p2}, Ljt/h;->a(Landroid/content/Context;I)Ljt/h;

    move-result-object p1

    iput-object p1, v0, Lcom/google/android/material/transformation/FabTransformationBehavior$a;->a:Ljt/h;

    .line 71
    new-instance p1, Ljt/j;

    const/16 p2, 0x11

    const/4 v1, 0x0

    invoke-direct {p1, p2, v1, v1}, Ljt/j;-><init>(IFF)V

    iput-object p1, v0, Lcom/google/android/material/transformation/FabTransformationBehavior$a;->b:Ljt/j;
