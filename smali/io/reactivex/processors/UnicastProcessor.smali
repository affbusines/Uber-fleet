...
.method a(ZZZLbaa/c;Lio/reactivex/internal/queue/SpscLinkedArrayQueue;)Z
    .registers 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(ZZZ",
    ...
    invoke-interface {p4, p1}, Lbaa/c;->onError(Ljava/lang/Throwable;)V
    ...
    .line 431
    :cond_34
    invoke-interface {p4}, Lbaa/c;->onComplete()V
...
.method c(Lbaa/c;)V
    ...
    .line 311
    invoke-virtual {v7}, Lio/reactivex/internal/queue/SpscLinkedArrayQueue;->cl_()Ljava/lang/Object;
    ...
    .line 314
    invoke-virtual/range {v0 .. v5}, Lio/reactivex/processors/UnicastProcessor;->a(ZZZLbaa/c;Lio/reactivex/internal/queue/SpscLinkedArrayQueue;)Z
    ...
    .line 322
    invoke-interface {v5, v15}, Lbaa/c;->onNext(Ljava/lang/Object;)V
...
.method d(Lbaa/c;)V
    ...
    .line 363
    :cond_2c
    invoke-interface {p1, v4}, Lbaa/c;->onNext(Ljava/lang/Object;)V
...
.method n()V
    ...
    .line 396
    invoke-virtual {p0, v1}, Lio/reactivex/processors/UnicastProcessor;->d(Lbaa/c;)V

    goto :goto_1f

    .line 398
    :cond_1c
    invoke-virtual {p0, v1}, Lio/reactivex/processors/UnicastProcessor;->c(Lbaa/c;)V
