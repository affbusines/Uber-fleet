...
.method public static a(Landroid/content/Context;Landroid/content/res/Resources;I)Ljava/nio/ByteBuffer;
    ...
    .line 136
    invoke-static {p0}, Ldm/l;->a(Landroid/content/Context;)Ljava/io/File;
    ...
    :cond_8
    :try_start_8
    invoke-static {p0, p1, p2}, Ldm/l;->a(Ljava/io/File;Landroid/content/res/Resources;I)Z
    ...
    :cond_12
    :try_start_12
    invoke-static {p0}, Ldm/l;->a(Ljava/io/File;)Ljava/nio/ByteBuffer;
...
.method public static a(Landroid/content/Context;Landroid/os/CancellationSignal;Landroid/net/Uri;)Ljava/nio/ByteBuffer;
    ...
    .line 113
    invoke-static {p0, p2, v1, p1}, Ldm/l$a;->a(Landroid/content/ContentResolver;Landroid/net/Uri;Ljava/lang/String;Landroid/os/CancellationSignal;)Landroid/os/ParcelFileDescriptor;
...
.method public static a(Landroid/content/Context;[Lds/f$b;Landroid/os/CancellationSignal;)Ljava/util/Map;
    .registers 8
    ...
    .line 228
    :cond_12
    invoke-virtual {v3}, Lds/f$b;->a()Landroid/net/Uri;
    ...
    .line 233
    :cond_1d
    invoke-static {p0, p2, v3}, Ldm/l;->a(Landroid/content/Context;Landroid/os/CancellationSignal;Landroid/net/Uri;)Ljava/nio/ByteBuffer;
...
.method public static a(Ljava/io/File;Landroid/content/res/Resources;I)Z
    ...
    .line 181
    :try_start_4
    invoke-static {p0, p1}, Ldm/l;->a(Ljava/io/File;Ljava/io/InputStream;)Z
    ...
    .line 183
    invoke-static {p1}, Ldm/l;->a(Ljava/io/Closeable;)V
...
.method public static a(Ljava/io/File;Ljava/io/InputStream;)Z
    ...
    .line 168
    invoke-static {v3}, Ldm/l;->a(Ljava/io/Closeable;)V
    ...
    .line 168
    invoke-static {v2}, Ldm/l;->a(Ljava/io/Closeable;)V
