...
.method public constructor <init>(Landroid/content/Context;Z)V
    ...
    .line 154
    iput v1, p0, Landroidx/appcompat/widget/v$a;->c:I

    goto :goto_25

    .line 156
    :cond_21
    iput v1, p0, Landroidx/appcompat/widget/v$a;->b:I

    .line 157
    iput v0, p0, Landroidx/appcompat/widget/v$a;->c:I
...
.method public a(Landroidx/appcompat/widget/u;)V
    ...
    .line 162
    iput-object p1, p0, Landroidx/appcompat/widget/v$a;->d:Landroidx/appcompat/widget/u;
...
.method public onHoverEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 201
    iget-object v0, p0, Landroidx/appcompat/widget/v$a;->d:Landroidx/appcompat/widget/u;

    if-eqz v0, :cond_5b

    .line 205
    invoke-virtual {p0}, Landroidx/appcompat/widget/v$a;->getAdapter()Landroid/widget/ListAdapter;
    ...
    invoke-virtual {p0, v3, v4}, Landroidx/appcompat/widget/v$a;->pointToPosition(II)I
    ...
    .line 227
    :cond_43
    iget-object v1, p0, Landroidx/appcompat/widget/v$a;->e:Landroid/view/MenuItem;
    ...
    .line 231
    iget-object v3, p0, Landroidx/appcompat/widget/v$a;->d:Landroidx/appcompat/widget/u;

    invoke-interface {v3, v0, v1}, Landroidx/appcompat/widget/u;->a(Landroidx/appcompat/view/menu/g;Landroid/view/MenuItem;)V

    .line 234
    :cond_52
    iput-object v2, p0, Landroidx/appcompat/widget/v$a;->e:Landroid/view/MenuItem;

    if-eqz v2, :cond_5b

    .line 237
    iget-object v1, p0, Landroidx/appcompat/widget/v$a;->d:Landroidx/appcompat/widget/u;

    invoke-interface {v1, v0, v2}, Landroidx/appcompat/widget/u;->b(Landroidx/appcompat/view/menu/g;Landroid/view/MenuItem;)V
...
.method public onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    .line 171
    invoke-virtual {p0}, Landroidx/appcompat/widget/v$a;->getSelectedView()Landroid/view/View;
    ...
    .line 172
    iget v2, p0, Landroidx/appcompat/widget/v$a;->b:I
    ...
    .line 176
    invoke-virtual {p0}, Landroidx/appcompat/widget/v$a;->getSelectedItemPosition()I

    move-result p1

    .line 177
    invoke-virtual {p0}, Landroidx/appcompat/widget/v$a;->getSelectedItemId()J

    move-result-wide v2

    .line 174
    invoke-virtual {p0, v0, p1, v2, v3}, Landroidx/appcompat/widget/v$a;->performItemClick(Landroid/view/View;IJ)Z
    ...
    .line 180
    iget v0, p0, Landroidx/appcompat/widget/v$a;->c:I
    ...
    .line 181
    invoke-virtual {p0, p1}, Landroidx/appcompat/widget/v$a;->setSelection(I)V
