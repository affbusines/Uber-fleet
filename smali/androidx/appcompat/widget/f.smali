...
.method public static declared-synchronized a()V
    ...
    iput-object v2, v1, Landroidx/appcompat/widget/f;->c:Landroidx/appcompat/widget/x;

    .line 62
    sget-object v1, Landroidx/appcompat/widget/f;->b:Landroidx/appcompat/widget/f;

    iget-object v1, v1, Landroidx/appcompat/widget/f;->c:Landroidx/appcompat/widget/x;

    new-instance v2, Landroidx/appcompat/widget/f$1;

    invoke-direct {v2}, Landroidx/appcompat/widget/f$1;-><init>()V

    invoke-virtual {v1, v2}, Landroidx/appcompat/widget/x;->a(Landroidx/appcompat/widget/x$f;)V
    :try_end_22
...
.method static a(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/af;[I)V
    ...
    .line 502
    invoke-static {p0, p1, p2}, Landroidx/appcompat/widget/x;->a(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/af;[I)V
...
.method public declared-synchronized a(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0, p1, p2}, Landroidx/appcompat/widget/x;->a(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
.method declared-synchronized a(Landroid/content/Context;IZ)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0, p1, p2, p3}, Landroidx/appcompat/widget/x;->a(Landroid/content/Context;IZ)Landroid/graphics/drawable/Drawable;
...
.method public declared-synchronized a(Landroid/content/Context;)V
    ...
    invoke-virtual {v0, p1}, Landroidx/appcompat/widget/x;->a(Landroid/content/Context;)V
    :try_end_6
...
.method declared-synchronized b(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v0, p1, p2}, Landroidx/appcompat/widget/x;->b(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
