...
.method static synthetic access$100(Lretrofit/RxSupport;Lbaj/k;Lretrofit/RxSupport$Invoker;Lretrofit/RequestInterceptorTape;)Ljava/lang/Runnable;
    .registers 4

    .line 14
    invoke-direct {p0, p1, p2, p3}, Lretrofit/RxSupport;->getRunnable(Lbaj/k;Lretrofit/RxSupport$Invoker;Lretrofit/RequestInterceptorTape;)Ljava/lang/Runnable;
...
.method private getRunnable(Lbaj/k;Lretrofit/RxSupport$Invoker;Lretrofit/RequestInterceptorTape;)Ljava/lang/Runnable;
    .registers 5
    ...
    invoke-direct {v0, p0, p1, p2, p3}, Lretrofit/RxSupport$2;-><init>(Lretrofit/RxSupport;Lbaj/k;Lretrofit/RxSupport$Invoker;Lretrofit/RequestInterceptorTape;)V
...
# virtual methods
.method createRequestObservable(Lretrofit/RxSupport$Invoker;)Lbaj/e;
    .registers 3
