...
# direct methods
.method constructor <init>(Lretrofit2/RequestFactory;Laxy/e$a;Lretrofit2/Converter;Lretrofit2/CallAdapter;Z)V
    .registers 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 179
    invoke-direct {p0, p1, p2, p3}, Lretrofit2/HttpServiceMethod;-><init>(Lretrofit2/RequestFactory;Laxy/e$a;Lretrofit2/Converter;)V
...
.method protected adapt(Lretrofit2/Call;[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 190
    invoke-static {p1, p2}, Lretrofit2/KotlinExtensions;->awaitNullable(Lretrofit2/Call;Lawj/d;)Ljava/lang/Object;
    ...
    .line 191
    :cond_18
    invoke-static {p1, p2}, Lretrofit2/KotlinExtensions;->await(Lretrofit2/Call;Lawj/d;)Ljava/lang/Object;
