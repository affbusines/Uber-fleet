...
# virtual methods
.method apply(Lretrofit2/RequestBuilder;Laxy/t;)V
    .registers 5

    if-eqz p2, :cond_6

    .line 245
    invoke-virtual {p1, p2}, Lretrofit2/RequestBuilder;->addHeaders(Laxy/t;)V
...
.method bridge synthetic apply(Lretrofit2/RequestBuilder;Ljava/lang/Object;)V
    ...
    .line 232
    check-cast p2, Laxy/t;

    invoke-virtual {p0, p1, p2}, Lretrofit2/ParameterHandler$Headers;->apply(Lretrofit2/RequestBuilder;Laxy/t;)V
